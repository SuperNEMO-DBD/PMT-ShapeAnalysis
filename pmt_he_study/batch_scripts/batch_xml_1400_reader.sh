...
ls $root_dir/data/raw_xml_files/*/*A1400_B1400* /unix/nemo3/PMT_He_Study_nemo3/data/raw_xml_files/*/*.xml > $root_dir/PMT-ShapeAnalysis/pmt_he_study/batch_files/$script_log_dir/filenames.ascii
data_file_list=`cat $root_dir/PMT-ShapeAnalysis/pmt_he_study/batch_files/$script_log_dir/filenames.ascii`
#
#
config_file="$root_dir/PMT-ShapeAnalysis/config_files/pmt_permeation_config.conf"
#
# ROOT macro to use:
...
do
  ...
  if test -f "$root_file"; then
    ...
    #
    interactive_command="$executable_plus_arguments >& $root_dir/PMT-ShapeAnalysis/pmt_he_study/batch_files/$script_log_dir/logs/batch_file_$ifile.log"
    ...
    echo "source $root_dir/PMT-ShapeAnalysis/pmt_he_study/setup.sh" >> $root_dir/PMT-ShapeAnalysis/pmt_he_study/batch_files/$script_log_dir/scripts/batch_file_$ifile.sh
